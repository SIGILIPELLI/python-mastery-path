...
line of code to production-grade, master-level engineering — with runnable code
...
| [Level 2 · Intermediate](level-2/index.md) | Idiomatic, testable Python | 9 topics + 1 project |
...
- Every topic page has runnable code snippets — copy them into a local `.py` file
  or a REPL and experiment.
