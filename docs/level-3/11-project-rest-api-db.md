...
<iframe width="100%" height="400" style="max-width:720px;aspect-ratio:16/9;height:auto;" src="https://www.youtube.com/embed/9iOLFc9RE8I" title="Video walkthrough" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
- [JavaScript — 11 · Project — REST API + Database](https://sigilipelli.github.io/javascript-mastery-path/level-3/11-project-rest-api-db/)
